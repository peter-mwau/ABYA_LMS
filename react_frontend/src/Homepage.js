		...
		<body class="framer-body-mlbahZRIo ">
			...
			>
				...
				>
					...
					>
						<section
							className="framer-19xs1qh"
							data-framer-name="Left"
							name="Left"
						>
							<div
								className="framer-166eo9p"
								data-framer-name="Container"
								name="Container"
							>
								<div
									className="framer-1c2m4v0"
									data-framer-name="About ABYA University:"
									style={{
										outline: "none",
										display: "flex",
								...
								>
									<h3
										style={{
											...
											lineHeight: "27.9px",
											color:
												"var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(235, 184, 29))",
										}}
								...
								<div
									className="framer-48pvrc"
									data-framer-name="Building a Learner-Driven Future"
									style={{
										outline: "none",
										display: "flex",
										flexDirection: "column",
								...
								<div
									className="framer-5fkyaf"
									data-framer-name="Spacer"
									name="Spacer"
								></div>
								<div
									className="framer-4ojh2g"
									style={{
										outline: "none",
										display: "flex",
										flexDirection: "column",
								...
								>
									<p
										...
										className="framer-text"
									>
										Discover the world of blockchain technology through
										comprehensive courses, expert-led training, and hands-on
										experience.
									</p>
								</div>
								<div
									className="framer-1iiqcub"
									data-framer-name="Spacer"
									name="Spacer"
								></div>
										...
										>
											<input
												...
												style={{
													...
													boxShadow:
														"inset 0 0 0 0px rgb(255, 255, 255), inset 0 0 0 1px var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(235, 184, 29))",
												}}
												data-1p-ignore="true"
											/>
					...
					<div class="framer-jgn26d" id="features">
						...
						>
							<h2
								style={{
									...
									backgroundImage:
										"linear-gradient(129deg, rgba(235, 235, 235, 0.94) 0%, rgba(255, 255, 255, 0.27) 94.1044%)",
									backgroundClip: "text",
						...
						<div
							class="framer-18qcomx"
							data-framer-name="Spacer"
							name="Spacer"
						></div>

						<div
							className="framer-f04faq"
							style={{
								outline: "none",
								display: "flex",
								flexDirection: "column",
						...
						>
							<p
								...
								className="framer-text"
							>
								Here at ABYA , we offer various courses of which most of them
								are Blockchain related and they are very detailed in terms of
								the content. You also access a large community support during
								your learning journey.
							</p>
						</div>

						<div
							class="framer-1yy1tc1"
							data-framer-name="Spacer"
							name="Spacer"
						></div>
						...
						<div class="framer-1lj2ix9">
							<div
								className="framer-ar9knc-container"
								style={{
									opacity: 1,
									transform:
										"perspective(1200px) translateX(0px) translateY(32px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
								}}
							>
								<a
									className="framer-ZHuJl framer-111mmjy framer-v-111mmjy framer-16x4q9s"
									...
									style={{
										...
										boxShadow:
											"0px 1px 2px 0px rgba(0, 0, 0, 0.25), 1px 1px 5px 0px var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(254, 232, 76))",
										width: "100%",
									}}
									href="./"
								>
									<div
										className="framer-by1oke"
										style={{
											background:
												"linear-gradient(180deg, rgb(66, 66, 20) 0%, rgb(51, 51, 20) 2.2552369263795087%, rgb(33, 33, 24) 100%)",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Explore the fundamentals of blockchain and its
											...
											<div className="framer-13qejrz">
												<div
													...
													style={{
														...
														flexShrink: 0,
														"--extracted-r6o4lv":
															"var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(254, 232, 76))",
														"--framer-link-text-color": "rgb(0, 153, 255)",
														"--framer-link-text-decoration": "underline",
														transform: "none",
													}}
												...
												>
													<p
														style={{
															...
															"--framer-text-alignment": "left",
															"--framer-text-color":
																"var(--extracted-r6o4lv, var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(254, 232, 76)))",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Learn how to design and deploy smart contracts on
							...
							<div
								className="framer-n59l5e-container"
								style={{
									opacity: 1,
									transform:
										"perspective(1200px) translateX(0px) translateY(32px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Understand how blockchain can revolutionize business
							...
							<div
								className="framer-1xbjsqh-container"
								style={{
									opacity: 1,
									transform:
										"perspective(1200px) translateX(0px) translateY(32px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Dive into the world of cryptocurrencies, including
													Bitcoin, Ethereum, and emerging digital assets.
												</p>
											</div>
											<div className="framer-13qejrz">
												<div
							...
							<div
								className="framer-1my40c2-container"
								style={{
									opacity: 1,
									transform:
										"perspective(1200px) translateX(0px) translateY(32px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Master the techniques to secure blockchain networks
							...
							<div
								className="framer-79ne5w-container"
								style={{
									opacity: 1,
									transform:
										"perspective(1200px) translateX(0px) translateY(32px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
										...
										>
											...
											>
												<p
													...
													className="framer-text"
												>
													Gain hands-on experience in building and deploying
					...
					<div class="framer-542be0" id="features-1">
						...
						>
							<p className="framer-text">
								Abya is your gateway to a world of knowledge and learning. We
								are dedicated to empowering the next generation of change
								leaders through innovative education and creative collaboration.
							</p>
						</div>
						...
						>
							<div
								aria-label="feature"
								class="framer-1i3ya54"
								data-border="true"
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-7i7jb7"
									data-border="true"
												...
												<div>
													<iconify-icon
														...
														style={{
															...
															color:
																"var(--token-a8e28c9d-4ce6-4ad2-96a7-a1a12837bc97, rgb(197, 142, 15))",
														}}
														rotate="0deg"
														flip="none"
													>
										...
										>
											<h3
												style={{
													...
													"--framer-font-family":
														'"Geologica", "Geologica Placeholder", sans-serif',
								...
								<div
									class="framer-17i3n8x"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-1wc6xmg"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-1mnfmso"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Choose from diverse courses, create your own learning
											path, and connect with expert mentors.
										</p>
									</div>
								</div>
							</div>
							...
							<div
								aria-label="feature"
								className="framer-1ftcs5w"
								data-border="true"
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-1ngxfol"
									data-border="true"
									data-framer-name="Top"
									name="Top"
								>
									...
									<div className="framer-uky70z">
										...
										>
											<img
												...
												src="https://framerusercontent.com/images/tdYnGTJeJF929QIECyV7QuQQP8.png"
												alt=""
												style={{
													display: "block",
													width: "100%",
								...
								<div
									className="framer-wztssl"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-uu982r"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-pn7p22"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Share your knowledge, create innovative content, and earn
							...
							<div
								aria-label="feature"
								className="framer-j2fvnj"
								data-border="true"
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-sjp8vs"
									data-border="true"
									data-framer-name="Top"
									name="Top"
								>
								...
								<div
									className="framer-iai1hh"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-130ortm"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-1c2xwng"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Join the DAO and actively shape the future of ABYA
											University.
										</p>
									</div>
								</div>
							...
							<div
								aria-label="feature"
								className="framer-q42dia"
								data-border="true"
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-1olhfm4"
									data-border="true"
									data-framer-name="Top"
									name="Top"
								>
									...
									<div className="framer-e3qcey">
										...
										>
											<img
												...
												src="https://framerusercontent.com/images/gs6Lao5K9GZWaQvC24QuKzVrIM.png"
												alt=""
												style={{
													display: "block",
													width: "100%",
								...
								<div
									className="framer-1h2brbf"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-1798y50"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-ffvhvz"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Build global connections, collaborate with peers, and be
							...
							<div
								aria-label="feature"
								className="framer-kuc0d3"
								data-border={true}
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-11r1zcv"
									data-border={true}
									data-framer-name="Top"
									name="Top"
								>
								...
								<div
									className="framer-qf797j"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-xyrlm9"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-1ru8t01"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Keep your learning data secure and under your control,
							...
							<div
								aria-label="feature"
								className="framer-19t12ib"
								data-border="true"
								data-framer-name="Feature"
								name="Feature"
							>
								<div
									className="framer-1g1xxae"
									data-border="true"
									data-framer-name="Top"
									name="Top"
								>
									...
									<div className="framer-s12xfd">
										...
										>
											<img
												...
												src="https://framerusercontent.com/images/I3gyBSI8AdYR56vr0AnaEaMdFs.png"
												alt=""
												style={{
													display: "block",
													width: "100%",
								...
								<div
									className="framer-1ju76qo"
									data-framer-name="Shadow"
									name="Shadow"
								></div>
								<div
									className="framer-16nh8iv"
									data-framer-name="Text Container"
									name="Text Container"
								>
									<div
										className="framer-1qikig5"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
									...
									>
										<p
											...
											className="framer-text"
										>
											Unlock cutting-edge capabilities with our innovative
						...
						<div class="framer-1g69kwy">
							<div className="framer-1er76e9-container">
								<div
									className="framer-7j5fb framer-1j1n4kr framer-v-1j1n4kr"
									data-framer-name="Variant 1"
									style={{
							...
							<div className="framer-78vs76-container">
								<div
									className="framer-DWYze framer-wacn66 framer-v-wacn66"
									data-framer-name="Variant 1"
									style={{
										backdropFilter: "blur(5px)",
										backgroundColor:
							...
							<div className="framer-1qlxbi9-container">
								<div
									className="framer-A5Ldq framer-1er97h0 framer-v-1er97h0"
									data-framer-name="Variant 1"
									style={{
										backdropFilter: "blur(5px)",
										backgroundColor:
							...
							<div className="framer-txtn5i-container">
								<div
									className="framer-ApmUF framer-6gllh3 framer-v-6gllh3"
									data-framer-name="Variant 1"
									style={{
										backdropFilter: "blur(5px)",
										backgroundColor:
					...
					<div
						class="framer-sjhb67"
						data-framer-name="Frame 1116606589"
						name="Frame 1116606589"
					>
						<div
							class="framer-10kbskc"
							data-framer-name="Div [mx-auto]"
							name="Div [mx-auto]"
						>
							<div
								class="framer-133kfbi"
								data-framer-name="Frame 1116606589"
								name="Frame 1116606589"
							>
								<div
									class="framer-17ffysw"
									data-framer-name="Div [flex-[4]]"
									name="Div [flex-[4]]"
								>
									<div
										className="framer-ajvuz8"
										data-framer-name="Paragraph"
										name="Paragraph"
									>
										<div
											className="framer-6u7phv"
											data-framer-name="and tell us more!"
											style={{
												outline: "none",
												display: "flex",
												flexDirection: "column",
										...
										<div
											className="framer-lwjixh"
											data-framer-name="Link [underline]"
											name="Link [underline]"
										>
											<div
												className="framer-1l5vv6"
												data-framer-name="Join our Discord"
												style={{
													outline: "none",
													display: "flex",
													flexDirection: "column",
										...
										<div
											className="framer-1eutkmf"
											data-framer-name="Have some feature request?"
											style={{
												outline: "none",
												display: "flex",
												flexDirection: "column",
									...
									<div
										className="framer-g12gt2"
										data-framer-name="Paragraph"
										name="Paragraph"
									>
										<div
											className="framer-mq4jqm"
											data-framer-name="See the milestones that brought us here,"
											style={{
												outline: "none",
												display: "flex",
												flexDirection: "column",
										...
										>
											<p
												...
												className="framer-text"
											>
												See the milestones that brought us here,{" "}
											</p>
										</div>
										<div
											className="framer-yb3arh"
									...
									<div
										className="framer-5gdb0k"
										data-framer-name="Our Roadmap"
										style={{
											outline: "none",
											display: "flex",
											flexDirection: "column",
								...
								<div
									className="framer-1fvnnjt"
									data-framer-name="Picture [flex-[10]]"
									name="Picture [flex-[10]]"
								>
									<div
										style={{
											position: "absolute",
						...
						<div class="framer-1oj1k3b-container">
							<ul class="logogrid">
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/fLHyXnMV/radiyal.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/W3JpDDYH/acme.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/HLnkgvwH/amara.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/hGtfGtqk/code-lab.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/CM3B40j8/fox-hub.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/R0g4p7y8/hex-lab.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/QtVs2BrM/hexa.png"
										class="logogrid__img"
									/>
								</li>
								<li class="logogrid__item">
									<img
										src="https://i.postimg.cc/LsD8KKYx/lightai.png"
										class="logogrid__img"
										alt="Netflix"
									/>
								</li>
					...
					>
						...
						>
							<h5
								style={{
									...
									"--framer-text-transform": "uppercase",
									backgroundImage:
										"linear-gradient(0deg, rgb(235, 235, 235) 0%, rgba(235, 235, 235, 0.23) 100%)",
									backgroundClip: "text",
									WebkitBackgroundClip: "text",
									color: "transparent",
								}}
						...
						<div
							className="framer-1qi98t5"
							data-framer-name="Spacer"
							name="Spacer"
						></div>

						<div
							className="framer-1c8tbe7"
							data-framer-name="Shiny Line"
							name="Shiny Line"
						></div>

						<div
							className="framer-aacje7"
							data-framer-name="Spacer"
							name="Spacer"
						></div>

						<div
							className="framer-1370bvb"
							data-framer-name="Metrics"
							name="Metrics"
						>
							<div
								className="framer-yk3j59"
								data-framer-name="Container"
								name="Container"
							>
								<div
									className="framer-1lfindj"
									data-framer-name="More cost effective"
									style={{
										outline: "none",
										display: "flex",
										flexDirection: "column",
							...
							<div
								className="framer-1atpwj8"
								data-framer-name="Seperator"
								name="Seperator"
							></div>
							<div
								className="framer-elterw"
								data-framer-name="Container"
								name="Container"
							>
								<div
									className="framer-fsrrie"
									data-framer-name="Faster ramp-up"
									style={{
										outline: "none",
										display: "flex",
										flexDirection: "column",
							...
							<div
								className="framer-1pgmtl4"
								data-framer-name="Seperator"
								name="Seperator"
							></div>
							<div
								className="framer-ewoapy"
								data-framer-name="Container"
								name="Container"
							>
								<div
									className="framer-1q8jijc"
									data-framer-name="More output"
									style={{
										outline: "none",
										display: "flex",
										flexDirection: "column",
							...
							<div
								className="framer-1rilcq2"
								data-framer-name="Seperator"
								name="Seperator"
							></div>
							<div
								className="framer-tk4tnk"
								data-framer-name="Container"
								name="Container"
							>
								<div
									className="framer-1xt3hml"
									data-framer-name="More output"
									style={{
										outline: "none",
										display: "flex",
					...
					>
						<h2 className="framer-text">
							<span
								...
								style={{
									backgroundImage:
										"linear-gradient(129deg, rgba(235, 235, 235, 0.94) 0%, rgba(255, 255, 255, 0.27) 91.1044%)",
								}}
								className="framer-text"
							>
								Voices of Success
					...
					>
						<p className="framer-text">
							Discover what our users say about the transformative impact of our
							platform.
						</p>
					</div>
											...
											<div className="swiper-wrapper">
												...
												<div className="swiper-slide">
													<div className="swiper-slide--inner">
														...
														<div className="testimonial-detail">
															<p>
																"The courses at Abya University have been
																instrumental in advancing my career in
																blockchain technology. The practical projects
																and expert guidance provided me with the
																confidence and skills needed to excel in this
																field."
															</p>
												...
												<div className="swiper-slide">
													<div className="swiper-slide--inner">
														...
														<div className="testimonial-detail">
															<p>
																"Abya University's LMS offers a comprehensive
																and engaging learning experience. The community
																support and resources available have been
																invaluable in my learning journey."
															</p>
									...
									<div className="company-details--row">
										<div className="company-box">
											<div className="company-box-inner">
												...
												<div className="company-box-bottom">
													<span>
														Enhanced Research - <strong>75% Growth</strong>
													</span>
												</div>
											</div>
										</div>
										<div className="company-box">
											<div className="company-box-inner">
												...
												<div className="company-box-bottom">
													<span>
														Smart Contract IDE - <strong>65% Growth</strong>
													</span>
												</div>
											</div>
										</div>
										<div className="company-box">
											<div className="company-box-inner">
												<div className="company-box-top">
													<center>
														<img
															src="https://i.postimg.cc/qRtq8DqQ/circle.png"
															alt="Company Name"
														/>
													</center>
												</div>
												<div className="company-box-bottom">
													<span>
														Team management - <strong>55% Growth</strong>
													</span>
												</div>
											</div>
										</div>
					...
					<div
						class="framer-12kovf6"
						data-framer-name="Spacer"
						name="Spacer"
					></div>

					<div
						className="framer-mqc7l5"
						style={{
							outline: "none",
							display: "flex",
							flexDirection: "column",
					...
					<div
						class="framer-1pbr6n0"
						data-framer-name="Spacer"
						name="Spacer"
					></div>

					<section
						aria-label="Success story articles"
						className="framer-rtxwb8"
						data-framer-name="Success Stories"
						name="Success Stories"
						style={{
							opacity: 1,
							transform:
								"perspective(1200px) translateX(0px) translateY(20px) scale(1) rotate(0deg) rotateX(0deg) rotateY(0deg) skewX(0deg) skewY(0deg) translateZ(0)",
						}}
					>
						<a
							className="framer-wk4igx framer-13nqg0n"
							data-framer-name="Item"
							name="Item"
							href="./"
						>
							<div
								className="framer-d91a1m"
								data-framer-name="Image Container"
								name="Image Container"
							>
								<div
									className="framer-vskvfp"
									data-framer-name="Image [object-cover]"
									name="Image [object-cover]"
								>
									<div
										style={{
											position: "absolute",
									...
									<div
										className="framer-1948sk5"
										data-framer-name="web5 1"
										name="web5 1"
									>
										<div
											style={{
							...
							<div
								className="framer-83wyc5"
								data-framer-name="Post"
								name="Post"
							>
								<div
									className="framer-16ee2at"
									...
									data-framer-component-type="RichTextContainer"
								>
									<h5 className="framer-text">
										Snippet: Discover how blockchain technology is
										revolutionizing the education sector.
									</h5>
								</div>

								<div
									className="framer-ew5l8a"
									data-framer-name="Spacer"
									name="Spacer"
								></div>
								<div
									className="framer-l1e3m2"
									data-border="true"
									id="the-rise-of-ai-in-marketing-a-game-changer-copy-l1e3m2"
									tabIndex={0}
								>
									<div
										className="framer-1t5ndzw"
										data-framer-name="Title"
										style={{
											outline: "none",
											display: "flex",
						...
						>
							...
							>
								...
								>
									<h5 className="framer-text">
										Snippet: Stay updated with the latest trends and predictions
								...
								<div
									className="framer-l1e3m2"
									data-border="true"
									id="optimizing-business-processes-with-api-management-a-strategic-approach-l1e3m2"
									tabIndex="0"
								>
									<div
										className="framer-1t5ndzw"
							...
							>
								...
								>
									<h5
										...
										className="framer-text"
									>
										Snippet: A beginner's guide to understanding and creating
								...
								<div
									className="framer-l1e3m2"
									data-border="true"
									id="demystifying-api-management-a-comprehensive-guide-for-beginners-l1e3m2"
									tabIndex="0"
								>
									<div
										className="framer-1t5ndzw"
					...
					>
						...
						<div
							class="framer-1b223ft"
							data-framer-name="Container"
							name="Container"
						>
							<div class="framer-2lalsq-container">
								<div
									className="framer-zyuWB framer-cjoy7j framer-v-cjoy7j"
									data-border="true"
									data-framer-name="Variant 1"
									style={{
								...
								>
									<div className="framer-17buv4w-container">
										<div
											className="framer-bo6aW framer-1cp7qdu framer-v-1cp7qdu"
												...
												>
													<p
														style={{
															...
															"--framer-text-alignment": "left",
															"--framer-text-color":
																"var(--extracted-r6o4lv, rgb(178, 179, 162))",
														}}
														className="framer-text"
													>
														What is ABYA LMS?
									...
									<div
										className="framer-1evj20f"
										data-framer-name="Shiny Line"
										style={{
											background:
												"linear-gradient(270deg, rgba(69, 205, 255, 0) 8.965240971280659%, rgb(238, 255, 0) 29.002218661407593%, rgb(255, 255, 255) 49.354739307284525%, rgb(255, 251, 0) 70.81166029828668%, rgba(0, 114, 156, 0) 94.95069641316402%)",
											opacity: 0.5,
										}}
									></div>
											...
											>
												...
												>
													<p
														...
														className="framer-text"
													>
														How can I communicate with my instructor or
														classmates?
													</p>
												</div>
											</div>
					...
					<section
						class="framer-szlmn7"
						data-framer-name="Waitlist"
						id="waitlist"
						name="Waitlist"
					>
						<div
							className="framer-182zjgq"
							data-framer-name="Container"
							name="Container"
						>
							<div
							...
							<div
								className="framer-1uscqb4"
								data-framer-name="Get early access and be the first to experience the future of seamless learning. Join the waitlist by providing your email below and hit 'Join' to stay ahead of the curve."
								style={{
									outline: "none",
									display: "flex",
									flexDirection: "column",
							...
							>
								...
								>
									...
									below and hit 'Join' to stay ahead of the curve.
								</p>
							</div>
						</div>
						...
						>
							...
							<div className="framer-nufu51">
								...
								>
									...
									>
										<a
											className="framer-text framer-styles-preset-1u4289p"
											data-styles-preset="bEiodWSQ3"
											href="./"
										>
											Overview
										</a>
							...
							<div class="framer-14swa2t-container">
								...
								>
									<div>
										...
										>
											...
											>
												<svg
													role="img"
													aria-label="whatsapp social icon"
									...
									<div>
										<a
											href="https://x.com/intent/tweet?text=undefined"
											className="social-icon id9d2fbc3b9aad4"
											target="_blank"
											style={{
												display: "inline-block",
									...
									<div>
										<a
											href="https://www.facebook.com/sharer/sharer.php?u=undefined"
											className="social-icon id9d2fbc3b9aad4"
											target="_blank"
											style={{
												display: "inline-block",
