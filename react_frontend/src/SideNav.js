...
const SideNav = () => {
	...
	return (
		...
		<aside
			...
			className="fixed top-[130px] md:top-[140px] lg:top-[130px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
			aria-label="Sidebar"
		>
			<div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-900 rounded-r-xl transition-all duration-1000">
				<ul className="space-y-2 font-medium">
					...
					<li>
						...
						>
							...
							<span className="flex-1 ms-3 whitespace-nowrap">IDE</span>
						</a>
					</li>
					<li>
						<a
					...
					<li>
						<button
							onClick={logout}
							className="flex items-center p-2 w-full text-start text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
						>
							<svg
								className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
								aria-hidden="true"
