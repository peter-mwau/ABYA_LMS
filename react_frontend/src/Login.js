        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit}>
              ...
              <button type="submit" onClick={handleSubmit} class="w-full bg-gray-300 hover:bg-yellow-400 hover:text-cyan-950 focus:ring-4 focus:outline-none focus:ring-yellow-500 text-cyan-950 rounded-lg text-md font-semibold px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
