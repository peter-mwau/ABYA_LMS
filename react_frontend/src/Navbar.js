				...
				<div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse flex-col">
					...
					>
						...
						<img
							...
							src={
								user && user.avatar ? `${baseUrl}${user.avatar}` : "Loading..."
							}
							alt="user photo"
						/>
					</button>
					...
					<div
						...
						} z-50 my-4 absolute mt-[50px] text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown`}
					>
						<div class="px-4 py-3">
