...
<nav class="bg-gray-50 border-gray-200 dark:bg-gray-900">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="#meme" class="block py-2 px-3 text-yellow-500 bg-yellow-500 rounded md:bg-transparent md:text-yellow-500 md:p-0 md:dark:text-yellow-400" aria-current="page">Dashboard</a>
      </li>
      <li>
      ...
      {/* togglemode btn */}
      <a href='#me' className='hover:bg-gray-400 hover:rounded-full' onClick={() => setDarkMode(!darkMode)}>
        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
