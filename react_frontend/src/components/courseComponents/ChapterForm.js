	...
	return (
		<div>
			...
			<form
				...
				className="h-full justify-between rounded w-full md:flex md:space-x-4"
			>
			...
			<label className="block text-gray-700 text-lg dark:text-gray-100 font-bold mb-2" htmlFor="chapter_description">
				...
				Course
						...
						<select
							...
							onChange={handleChange}
							className="appearance-none mt-2 rounded-lg dark:bg-gray-700 dark:text-gray-50 w-full p-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
						>
					...
					<select
						...
						onChange={handleChange}
						className="appearance-none p-4 dark:bg-gray-700 dark:text-gray-50  rounded-lg w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-2 mt-4"
					>
