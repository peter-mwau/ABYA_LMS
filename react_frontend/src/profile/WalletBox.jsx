		...
		<div className="md:w-3/5 bg-slate-100 shadow-md rounded-lg py-2 px-4 w-full flex-1">
			<div className="md:flex items-center justify-between md:space-x-3">
				<aside className="flex items-center space-x-4 md:mr-10">
					...
					<div>
						...
						<div className="flex flex-row gap-3">
							...
							<input type="radio" className={`${isWalletConnected ? 'text-green-500 bg-green-500 my-auto' : 'text-red-500 bg-red-500'}`}/>
						</div>
					</div>
				</aside>
				...
				<div className="md:w-1/3 mt-2 md:mt-0">
					...
					<p className="text-xl font-bold text-gray-900">{isWalletConnected ? <span className="text-yellow-500 font-semibold">{balance}</span> : '0'}</p>
				</div>
			</div>
