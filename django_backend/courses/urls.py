...
urlpatterns = [
    ...
    path('api/course/<int:pk>/', views.CourseDetailAPI.as_view(), name='course_detail_api'),
    ...
    path('api/enroll-course/<int:pk>/', views.EnrollCourseAPI.as_view(), name='enroll-course-api'),
    path('api/unenroll-course/<int:pk>/', views.UnenrollCourseAPI.as_view(), name='unenroll-course-api'),
    ...
    path('api/video/progress/', views.UpdateVideoProgressAPI.as_view(), name='update_video_progress'),
    path('api/achievements/', views.AchievementsAPI.as_view(), name='achievements_api'),
